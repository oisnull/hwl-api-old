...
{
    public static class StackExchangeRedisManager
    {
        //127.0.0.1:6379,allowadmin=true
        private static readonly string Coonstr = RedisConfigService.UserDynamicRedisHosts; //ConfigurationManager.AppSettings["DefaultRedisExchangeHosts"].ToString();
        ...
        static StackExchangeRedisManager()
        {
        }
        ...
        {
            connectionString = connectionString ?? Coonstr;
