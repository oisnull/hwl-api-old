(function () {
    ...
    var utils = UM.utils,
        ...
        Base = {
            ...
            callback: function (editor, $w, url, state, error) {
    ...
    var Upload = {
        ...
        uploadComplete: function (r) {
            ...
            try {
                ...
                Base.callback(me.editor, me.dialog, '', (lang && lang.uploadError) || 'Error!', (lang && lang.uploadError) || 'Error!');
            }
        },
    ...
    UM.registerWidget('image', {
        ...
        Base.callback(editor, $w, url, state, 'function (editor, $w, url, state)')
    })
})();
